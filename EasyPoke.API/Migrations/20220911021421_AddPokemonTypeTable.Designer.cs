...
namespace EasyPoke.API.Migrations
{
    ...
    [Migration("20220911021421_AddPokemonTypeTable")]
    partial class AddPokemonTypeTable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EasyPoke.API.Models.GrowthRateLevelExperience", b =>
                {
                    ...
                    b.Property<int>("ParentGrowthRateId")
                        .HasColumnType("int");

                    b.HasKey("Id");

                    b.HasIndex("ParentGrowthRateId");

                    b.ToTable("GrowthRateLevelExperience");
                });
            ...
            modelBuilder.Entity("EasyPoke.API.Models.GrowthRateLevelExperience", b =>
                {
                    b.HasOne("EasyPoke.API.Models.GrowthRate", "ParentGrowthRate")
                        .WithMany("LevelExperiences")
                        .HasForeignKey("ParentGrowthRateId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("ParentGrowthRate");
                });
